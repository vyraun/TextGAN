...
flags.DEFINE_float  ("min_d_acc",         0.925,   "Update generator if descriminator is better " \
                                                   "than this")
flags.DEFINE_float  ("max_d_acc",         0.975,   "Update descriminator if accuracy less than " \
                                                   "this")
flags.DEFINE_float  ("max_perplexity",    15.0,    "Scheduler maintains perplexity to be under " \
                                                   "this")
