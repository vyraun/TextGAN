...
flags.DEFINE_float  ("min_d_acc",         0.92,    "Update generator if descriminator is better " \
                                                   "than this")
flags.DEFINE_float  ("max_d_acc",         0.985,   "Update descriminator if accuracy less than " \
                                                   "this")
